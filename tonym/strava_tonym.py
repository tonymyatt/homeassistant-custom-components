...
from .secrets import STRAVA_TOKEN
...
class StravaTonym:
    """Class for reading data from my Strava account."""
    ...
    def calc_weekly_strava_stats(self) -> dict[str:CycleWeekStats]:
        ...
        last_week.distance_delta = (
            last_week.distance / data[mon_last_fnight]["distance"] * 100
        )
        ...
        this_week.distance_delta = (
            this_week.distance / data[mon_last_week]["distance"] * 100
        )
